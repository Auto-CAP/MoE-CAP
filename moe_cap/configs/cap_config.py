...
class CAPConfig:
    ...
    Attributes:
        ...
        num_samples: Number of samples to use. In fixed-length mode, controls how many
                     synthetic prompts to generate. In regular mode, takes the first N
                     samples from the dataset (deterministic).
    """
